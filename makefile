...
VERSION   ?= $(call get_gh_version,louislam/uptime-kuma)

TESTCMD   := \
	uname -a; \
	node --version; \
	npm --version; \
	grep "\"version\"\:" /home/alpine/project/package.json; \
	#
# -- }}}
...
# runtime flags
MOUNTFLAGS := \
	# -v $(CURDIR)/data:/home/alpine/project/data \
